...
public abstract class FileReader {
  ...
  protected int checkForReceipt(BufferedReader inputStream) 
    ...
    while (!isEmpty(line = inputStream.readLine())) {
      ...
      String format = checkFormat(values);
      if(format == "xml") {
  ...
  protected abstract String checkFormat(String values[]);
  protected abstract String getValue(String values[]) throws WrongFileFormatException;
  ...
  protected String getValueOfField(String fieldsLine) 
    ...
    try {
      ...
      String valueOfField = getValue(values);
      return valueOfField;   
